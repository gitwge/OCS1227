...
namespace TestSetPosition
{
    public class DBtest
    {
        ...
        public  DBtest()
        {
            try
            {
                //string sql = "select * from sim_rgvinfo_his where [LoaderStatus] = 1 order by CurrentTime asc ";
                //string sql = "select * from sim_rgvinfo_his where CurrentTime >'2016-10-07 11:44:54.790' order by CurrentTime asc ";
